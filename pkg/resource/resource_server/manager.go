...
// +kubebuilder:rbac:groups=cognitoidentityprovider.services.k8s.aws,resources=resourceservers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=cognitoidentityprovider.services.k8s.aws,resources=resourceservers/status,verbs=get;update;patch
