...
const (
	FinalizerString = "finalizers.cognitoidentityprovider.services.k8s.aws/ResourceServer"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("resourceservers")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.ResourceServer{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.ResourceServer),
	}
}
